...
class Ayahs {
  ...
  int? ruku;
  int? hizbQuarter;
 // bool? sajda; it was previous throwing error
  dynamic sajda;
...
Future<SurahModel> fetchSurah(
    {required int surahNumber,
    required String language,
    required String edition}) async {
  try {
    print('surah url:' +
        '${Keys.surahEndPoint}${surahNumber}/$language.$edition');

    final response = await http.get(
        Uri.parse('${Keys.surahEndPoint}${surahNumber}/$language.$edition'));
   ...
   // print(response.body);
    if (response.statusCode == 200) {
      ...
      throw Exception('Failed to load Surah with gievn number');
    }

  } catch (e) {
    // Handle any errors that occur during the HTTP request.
    print('Error fetching Failed to load Surah with gievn number: $e');
    throw Exception('Failed to load Surah with gievn number');
  }
}
